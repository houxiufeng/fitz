...
public class SqlAssembleUtils {
     ...
     * @return
     */
    public static BoundSql buildDeleteSql(Class<?> clazz, int id, NameHandler nameHandler) {
     ...
     * @return bound sql
     */
    public static BoundSql buildByIdSql(Class<?> clazz, int id, Criteria criteria,
    ...
    public static BoundSql buildListSql(Object entity, Criteria criteria, NameHandler nameHandler) {
        ...
        if (sb.length() < 11) {
            sb.append(boundSql.getPrimaryKey()).append(" ASC");
        }
